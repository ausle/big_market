...
import api.IRaffleActivityService;
import api.dto.ActivityDrawRequestDTO;
import api.dto.ActivityDrawResponseDTO;
import api.dto.UserActivityAccountRequestDTO;
import api.dto.UserActivityAccountResponseDTO;
...
public class RaffleActivityController implements IRaffleActivityService {
    ...
    /**
     * 判断是否签到接口
     * 主要就是判断，某个用户，某一天有没有返利流水。没有则认为可以签到。
     */
