...
public class RaffleActivityOrderDaoTest {
    ...
    public void test_insert_random() {
        for (int i = 0; i < 5; i++) {
            ...
            raffleActivityOrder.setSku(10000l);
            raffleActivityOrder.setOutBusinessNo("10000");
            raffleActivityOrder.setTotalCount(111);
            raffleActivityOrder.setDayCount(11);
            raffleActivityOrder.setMonthCount(111);
            // 插入数据
